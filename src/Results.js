            ...
            <div key={idx} className='search-result'>
              ...
              {rootList.map((root, rIdx) => (
                <div key={rIdx} className='root-result'>
                  ...
                  <div className='hw-result'><a href={DataLoader.findPageImage(root, 'hw', hwIndex)} target="_blank">HW</a>/<a href={DataLoader.findPageImage(query, 'hw', hwIndex)} target="_blank">HW(a)</a></div>

                  <div className='sg-result'><a href={DataLoader.findPageImage(root, 'sg', sgIndex)} target="_blank">SG</a>/<a href={DataLoader.findPageImage(query, 'sg', sgIndex)} target="_blank">SG(a)</a></div>
                </div>
              ))}
            </div>
            </div>
