...
const About = () => {
    return (
        <div className='about p10 m-auto'>
            ...
            <p>There are a variety of searchable Arabic dictionaries available online, which is *not* the focus of this tool, even though ishtiqāq shares much of this functionality. At its core, ishtiqāq is an aid for reading manuscripts where you come across a rasm (consonantal skeleton) that is unclear or whose letters are ambiguous. With ishtiqāq you can identify unclear letter(s) and, with a single search, retrieve multiple results based on the different possible spellings of the word. To learn more about the functionality, check the How To page.</p>
